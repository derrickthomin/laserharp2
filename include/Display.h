...
// Vars
extern bool          update_display;          // Set to yes anywhere to tell the screen code to do stuff
...
extern bool          outer_menu;               // True = we are on the main screen loop. False = we are in the sub-screen options
