...
extern AudioSynthKarplusStrong  *string[14];
extern AudioSynthSimpleDrum     *drum[14];
extern AudioSynthWaveform       *pad[14];
extern AudioEffectEnvelope      *envelope[14];
extern AudioEffectEnvelope      *envelope_pad[14];
extern AudioMixer4              *SubMixers[10];
extern AudioAnalyzePeak         *peaks[3];
